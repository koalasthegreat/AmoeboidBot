...
from image_processing import img_to_bytearray, stitch_images_horz
from cards import MagicCardRuling
...
DB_NAME = getenv("DB_NAME", default="bot.db")
REFRESH_INTERVAL = int(getenv("REFRESH_INTERVAL", default=24))
